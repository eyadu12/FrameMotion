  ...
  return (
    <div className="flex flex-col gap-10 overflow-x-hidden">
      ...
      <section className="flex flex-col gap-10 mb-10" ref={containerRef}>
        ...
        >
          This is just a demo website to showcase my animation skill. It is created by frame-Motion and it
          will make your webstie more engaging, interactive and bring life to it!
        ...
        <motion.p
          ...
          className="text-slate-100 font-thin text-4xl w-1/2 mx-auto"
        >
          Have fun playing with  My project create withFramer Motion. It is a very powerful library,
          which will bring life to your website
        </motion.p>
      </section>
    </div>
  )
